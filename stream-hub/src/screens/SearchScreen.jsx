...
import { fetchTrendingMovies, fetchTopAnime, searchMulti, IMAGE_BASE_URL } from "../services/api";

const { width: SCREEN_WIDTH } = Dimensions.get("window");
const COLUMN_WIDTH = (SCREEN_WIDTH - 52) / 2;
const FILTER_TABS = ["All", "Movies", "Anime"];
...
const styles = StyleSheet.create({
  ...
  searchHeader: { paddingHorizontal: 20, marginTop: 10, marginBottom: 10 },
  searchBar: {
    flexDirection: "row",
    alignItems: "center",
  ...
  filterChipActive: { backgroundColor: "#FF334B", borderColor: "#FF334B" },
  filterText: { color: "#8D8D99", fontSize: 12, fontWeight: "600" },
  ...
  resultsTitle: { color: "#FFF", fontSize: 15, fontWeight: "700" },
  resultsCount: { color: "#7E7E8A", fontSize: 12 },
  ...
  emptyText: { color: "#FFF", fontSize: 16, fontWeight: "700", marginTop: 12 },
  emptySubtext: { color: "#7E7E8A", fontSize: 12, marginTop: 4 },
});
